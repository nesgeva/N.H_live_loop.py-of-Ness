#!/usr/bin/env bash
#
# NH_SHADOW_REHEARSAL_LAUNCHER_v3.sh
#
# N.H SHADOW LIVE REHEARSAL LAUNCHER — v3  (CLOSED REPAIR-9 CONTROLLER)
#
# WHAT THIS IS
...
#
# ==========================================================================
# WHAT v3 IS, AND WHAT IT CHANGES
# ==========================================================================
#
...
#
# USAGE
#   bash /home/ness/NH_CLAUDE_CODEX_DESIGN_LOOP/controller/NH_SHADOW_REHEARSAL_LAUNCHER_v3.sh
#
...
# --- controller: THE CLOSED REPAIR-9 IDENTITY ---
readonly EXP_LOOP_SHA="acc8dee2c3ae0a27738fc1c1b4b08bb30bb55243d8ce9c22c393c6505e798690"
readonly EXP_LOOP_BYTES="1382464"
readonly EXP_LOOP_LINES="30473"
...
readonly LAB="/home/ness/NH_AICP_SHADOW_REHEARSAL_REPAIR9_acc8dee2c3ae0a27738fc1c1b4b08bb30bb55243d8ce9c22c393c6505e798690"
...
assert_frozen_identities() {
  ...
  # Launcher v3 is THIS file. It cannot hash-gate on itself, but it must be the
  # file that is present, and it is carried in the before/after proof set so any
  # change to it during the run is caught.
  [ -s "${CTRL}/${LAUNCHER_V3_BASENAME}" ] \
    || die "launcher v3 is missing or empty at ${CTRL}/${LAUNCHER_V3_BASENAME}"
  note "all three launcher artefacts present in ${CTRL}"
  ...
  ctrl_status_expected="$(
    printf '%s\n' \
      ...
      "?? ${LAUNCHER_V3_BASENAME}" | LC_ALL=C sort
  )"
...
SHADOW_TOKEN="nh-shadow-repair9-${EXP_LOOP_SHA}"
...
printf '\n'
printf '==================================================\n'
printf 'N.H SHADOW LIVE REHEARSAL (v3, CLOSED REPAIR-9) — RESULT\n'
printf '==================================================\n'
printf 'SHADOW_LAB=%s\n'               "$LAB"
