#!/usr/bin/env bash
#
# NH_SHADOW_REHEARSAL_LAUNCHER_v17.sh
#
# N.H SHADOW LIVE REHEARSAL LAUNCHER — v17
...
#
#   ITS DIRECT PREDECESSOR, v16, WAS CONSTRUCTED AND NEVER RUN. There is
#   therefore NO completed v16 rehearsal lab, none is claimed anywhere in this
#   file, none is required by anything in it, and v16 is never executed by it.
#   v16 is preserved launcher history and is gated here by exact identity like
#   every launcher before it.
#
...
#             controller result, and v17 records it without reinterpreting it.
#
...
# (I-03..I-07). In v17 it is PRESERVED EVIDENCE ONLY. It is never the refresh
...
# defect. In v17 it is PRESERVED EVIDENCE ONLY, on exactly the same terms as
...
# --- controller: THE ACCEPTED REPAIR-25 CANDIDATE -- THE SOLE v17 REFRESH SOURCE
#
# THIS IS THE ONE FILE v17 EXISTS TO EXERCISE, and it is the ONLY controller
...
readonly LAB="/home/ness/NH_AICP_SHADOW_REHEARSAL_REPAIR25_V17_91b89aadafe613f28393269c6dcb3321d8872de0bf6c97f3cdbc874be7e97595_rs_2593b06ab1684bbf19a6ffb70d915bd2"
...
# THE ONE NEW v17 OBSERVATION FIELD.
#
...
assert_frozen_identities() {
  ...
  # THE REPAIR-22 CANDIDATE -- PRESERVED REPAIR EVIDENCE in v17, not the refresh
  # source. Gated exactly as strictly as the real controller and equally never
  # written to.
  ...
  # THE ACCEPTED REPAIR-25 CANDIDATE -- THE SOLE v17 REFRESH SOURCE, gated exactly
  ...
  # v16 is this file's DIRECT PREDECESSOR AND IT WAS NEVER RUN. It was
  # constructed and independently audited and Ness did not execute it, so no v16
  # lab exists and none is claimed. It is preserved launcher history and is now
  # gated by exact identity like v1..v15. v17 never runs it.
  ...
  # Launcher v17 is THIS file. It cannot hash-gate on itself, so it is accounted
  # for BY PRESENCE, and it is carried in the before/after proof set so any change
  # to it during the run is caught there instead.
  [ -s "${CTRL}/${LAUNCHER_V17_BASENAME}" ] \
    || die "launcher v17 is missing or empty at ${CTRL}/${LAUNCHER_V17_BASENAME}"
  note "all seventeen launcher artefacts present in ${CTRL}"
...
SHADOW_TOKEN="nh-shadow-repair25-integrated-v17-${EXP_R25_SHA}-${EXP_ROUTED_SIGNAL_ID}"
...
# disposable v17 shadow, which is the corrected Repair-19 behaviour this
...
if ! stage_may_continue; then
  ...
  if ! stage_may_continue; then
    ...
    if ! stage_may_continue; then
      ...
      #
      # WHATEVER EXECUTE REPORTS IS THE CONTROLLER RESULT, AND v17 RECORDS IT
...
# ==========================================================================
# SECTION 11b — v17 STAGE OBSERVATIONS
...
step "v17 STAGE OBSERVATIONS"

observe_v17_stages() {
  local out="${PROOF}/v17-stage-observations.txt"
  ...
  {
    printf 'v17 STAGE OBSERVATIONS -- descriptive only, no verdict\n'
    printf '=====================================================================\n\n'
...
observe_exact_regressions() {
...

  {
    ...
    printf '  THIS IS NOT v17\047S PURPOSE. v17 is the fresh integrated end-to-end\n'
    ...
    printf 'HOW A STAGE-1 OUTCOME IS READ IN v17\n'
...
# already independently audited and offline-tested; v17 is an INTEGRATED
...
observe_repair25_chatgpt_stop_handoff() {
...

  {
    ...
    if [ "$verdict" = "NOT-EXERCISED" ]; then
      ...
      printf '  is invoked to force the path. v17 is an integrated rehearsal, not\n'
...
printf '\n'
printf '===========================================================\n'
printf 'N.H SHADOW REHEARSAL (v17, ACCEPTED REPAIR-25, INTEGRATED) — RESULT\n'
printf '===========================================================\n'
printf 'SHADOW_LAB=%s\n'                        "$LAB"
printf 'REGRESSION_SOURCE=%s\n'                 "$REGRESSION_SOURCE"
printf 'REGRESSION_SOURCE_MODE=%s\n'            "$REGRESSION_SOURCE_MODE"
...
printf 'V17_INJECTED_A_FINDING_TO_FORCE_THE_BRANCH=NO\n'
printf 'V17_INVOKED_ROUTE_AUDIT_FINDING=NO\n'
printf 'V17_INVOKED_A_SECOND_QUESTION_VALIDATION=NO\n'
printf 'V17_INVOKED_NEXT_QUESTION_GROUP=NO\n'
printf 'V17_INVOKED_RECORD_NESS_ANSWER=NO\n'
printf '\n'
...
printf 'PROOF_V17_OBSERVATIONS=%s\n'                 "${PROOF}/v17-stage-observations.txt"
