#!/usr/bin/env bash
#
# NH_SHADOW_REHEARSAL_LAUNCHER_v22.sh
#
# N.H SHADOW LIVE REHEARSAL LAUNCHER — v22
...
# v21 is THIS file's DIRECT PREDECESSOR AND IT RAN, exactly once, against the
...
# disk when v22 was frozen. v22 never runs it.
...
# --- ACCEPTED REPAIR 28: THE SOLE SHADOW-CONTROLLER REFRESH SOURCE OF v22 ---
#
...
# --------------------------------------------------------------------------
#
# WHY THIS GATE EXISTS. v22 continues the state the v21 CLAUDE_SPECIFICATION_STOP
# happened in. If the recorded v21 result is not what this launcher believes it
# is, the whole premise of v22 is false. So the v21 result is PROVED, from the
...
readonly LAB="/home/ness/NH_AICP_SHADOW_REHEARSAL_REPAIR28_CONTINUATION_V22_6d5e716fc6b2d777c4f65c726588a6e96b98ee67277f907c7d253ecc48edc172_rs_2593b06ab1684bbf19a6ffb70d915bd2"
...
# The completed v21 lab is THIS FILE'S DIRECT PREDECESSOR EVIDENCE and, uniquely,
...
assert_frozen_identities() {
  ...
  # source. It is gated by exact identity like v1..v20. v22 never runs it.
  ...
  # Launcher v22 is THIS file. It cannot hash-gate on itself, so it is accounted
  ...
  [ -s "${CTRL}/${LAUNCHER_V22_BASENAME}" ] \
    || die "launcher v22 is missing or empty at ${CTRL}/${LAUNCHER_V22_BASENAME}"
  note "all twenty-two launcher artefacts present in ${CTRL}"
...
# carries.
SHADOW_TOKEN="nh-shadow-repair28-continuation-v22-${EXP_R28_SHA}-${EXP_ROUTED_SIGNAL_ID}"
...
# ==========================================================================
# SECTION 11b — v22 STAGE OBSERVATIONS
...
# truncated.
step "v22 STAGE OBSERVATIONS"

observe_v22_stage() {
  local out="${PROOF}/v22-stage-observations.txt"
  local s4="$S4_OUT"
  ...
  {
    printf 'v22 STAGE OBSERVATIONS -- descriptive only, no verdict\n'
    printf '=====================================================================\n\n'
...
printf 'V22_INJECTED_A_FINDING_TO_FORCE_THE_BRANCH=NO\n'
printf 'V22_INVOKED_ROUTE_AUDIT_FINDING=NO\n'
printf 'V22_INVOKED_QUESTION_VALIDATION=NO\n'
printf 'V22_INVOKED_QUESTION_COVERAGE_REVIEW=NO\n'
printf 'V22_INVOKED_INTERVIEW_GATE=NO\n'
...
printf 'PROOF_V21_OBSERVATIONS=%s\n'                 "${PROOF}/v22-stage-observations.txt"
