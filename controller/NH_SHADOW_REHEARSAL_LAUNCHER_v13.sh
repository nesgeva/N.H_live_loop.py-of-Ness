...
readonly LAB="/home/ness/NH_AICP_SHADOW_REHEARSAL_REPAIR19B_V13_235885af469a6b5f3f428d206c77072712ef4b8d68caa37acf43445fc321bf02_rs_2593b06ab1684bbf19a6ffb70d915bd2"
...
assert_frozen_identities() {
  ...
  [ -s "${CTRL}/${LAUNCHER_V13_BASENAME}" ] \
    || die "launcher v13 is missing or empty at ${CTRL}/${LAUNCHER_V13_BASENAME}"
  note "all thirteen launcher artefacts present in ${CTRL}"
  ...
  ctrl_status_expected="$(
    printf '%s\n' \
      ...
      "?? ${LAUNCHER_V13_BASENAME}" | LC_ALL=C sort
  )"
...
SHADOW_TOKEN="nh-shadow-repair19b-regression-v13-${EXP_LOOP_SHA}-${EXP_ROUTED_SIGNAL_ID}"
...
step "REPAIR-19B REGRESSION V13 OBSERVATIONS"

observe_repair19b_regression_v13() {
  local out="${PROOF}/repair19b-regression-v13-observations.txt"
  ...
  {
    printf 'REPAIR-19B REGRESSION V13 OBSERVATIONS -- descriptive only, no verdict\n'
    printf '=====================================================================\n\n'
...
observe_repair19b_regression_v13 || true
...
printf '\n'
printf '===========================================================\n'
printf 'N.H SHADOW REHEARSAL (v13, REPAIR-19B REGRESSION) — RESULT\n'
printf '===========================================================\n'
printf 'SHADOW_LAB=%s\n'                        "$LAB"
printf 'REGRESSION_SOURCE=%s\n'                 "$REGRESSION_SOURCE"
printf 'REGRESSION_SOURCE_MODE=%s\n'            "$REGRESSION_SOURCE_MODE"
...
printf 'PROOF_V13_OBSERVATIONS=%s\n'                 "${PROOF}/repair19b-regression-v13-observations.txt"
printf '===========================================================\n'
