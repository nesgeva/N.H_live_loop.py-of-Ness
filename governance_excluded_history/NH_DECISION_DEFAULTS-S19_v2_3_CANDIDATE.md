# N.H — DECISION DEFAULTS (S19) — v2.3 CANDIDATE — NOT ADOPTED
# Behavioral guide for N.H design and build sessions.
#
# ===================== CANDIDATE STATUS — READ FIRST =====================
#
# STATUS: CANDIDATE. NOT ADOPTED. NOT AUTHORITATIVE.
#
# NH_DECISION_DEFAULTS-S19_v2_2.md REMAINS THE ACTIVE, ADOPTED DECISION
# DEFAULTS and stays in force until Ness explicitly adopts a successor.
# This candidate does not replace it, does not modify it, and acquires no
# authority from its filename. Adopted v2.2 identity, verified unchanged
# when this candidate was produced:
#   SHA-256 6cd09329e12ba9de78b96d02347a765b65191ec6f7050f62f71d4a831baee696
#   314 lines, 37048 bytes
#
# WHY THIS CANDIDATE EXISTS — ONE BOUNDED RECONCILIATION ONLY.
# It was produced solely to reconcile the §0 live-loop working-role rule
# with Ness's approved decision of 2026-08-13, recorded in:
...
# Exactly one behavioral rule was changed: the §0 working-division bullet.
# Every other rule in v2.2 is carried through unchanged.
#
# WHAT THIS CANDIDATE DOES NOT DO.
# It performs NO new Decision-Defaults-to-Master resynchronization. The
# "Synced to" and Master-hash lines below are CARRIED THROUGH UNCHANGED FROM
# v2.2 and still name Master 19; they are lineage, not a fresh sync claim.
# The Master-19 -> Master V10 drift remains recorded where it already is
# (Map Register D; regeneration task C5) and is untouched here. Unrelated
# stale wording elsewhere in this file was deliberately NOT cleaned up, so
# that this bounded change stays reviewable line by line.
#
# =========================================================================
#
# Synced to: NH_MASTER-19_CORRECTED_v7_1.md (adopted authoritative Master, June 28 2026)
#   [carried unchanged from v2.2 — see CANDIDATE STATUS above; no new sync performed]
# Hash of authoritative Master: 0e8b59e3ce8fd1b4f57367ff524fd2d467d905bb7a789745d13e7f81bd2665cf
# Supersedes: nothing yet — v2.2 remains adopted. On adoption this would
#   supersede NH_DECISION_DEFAULTS-S19_v2_2.md and all prior versions.
#   (v2.2's own line read: "Supersedes: NH_DECISION_DEFAULTS-S17_AUDITED_v1.md")
#
# Adopted lineage: NH_DECISION_DEFAULTS-S19_v2_2.md — adopted by Ness
# (June 28 2026), which superseded v2.1 and all prior Decision Defaults.
#
